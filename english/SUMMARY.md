...
* [ArchiFilm(beta) - Closed](add-ins/archi-film-beta/README.md)
  * [Manual](add-ins/archi-film-beta/manual/README.md)
    * [(A) Credit, Send Feedback](add-ins/archi-film-beta/manual/a-credit-send-feedback.md)
    * [(B) Hub, Preset List](add-ins/archi-film-beta/manual/b-hub-preset-list.md)
    * [(C) Canvas, Settings](add-ins/archi-film-beta/manual/c-canvas-settings.md)
    * [(D) Image, Gallery](add-ins/archi-film-beta/manual/d-image-gallery.md)
  * [Tutorial](add-ins/archi-film-beta/tutorial/README.md)
    * [1. How to use top 3 Images](add-ins/archi-film-beta/tutorial/1.-how-to-use-top-3-images.md)
    * [2. How to use ArchiFilm Hub](add-ins/archi-film-beta/tutorial/2.-how-to-use-archifilm-hub.md)
    * [3. How to use Canvas](add-ins/archi-film-beta/tutorial/3.-how-to-use-canvas.md)
    * [4. How to use Presets](add-ins/archi-film-beta/tutorial/4.-how-to-use-presets.md)
    * [5. How to Generated Images](add-ins/archi-film-beta/tutorial/5.-how-to-generated-images.md)
    * [6. How to use Credits, Feedback](add-ins/archi-film-beta/tutorial/6.-how-to-use-credits-feedback.md)
    * [7. How to use Prompt Boost](add-ins/archi-film-beta/tutorial/7.-how-to-use-prompt-boost.md)
  * [Version History](add-ins/archi-film-beta/version-history.md)
