...
* [Filter+ Section Box](add-ins/filter+-section-box/README.md)
  * [Toggle Section Box](add-ins/filter+-section-box/toggle-section-box.md)
  * [Manage Section Box - Box List](add-ins/filter+-section-box/manage-section-box-box-list.md)
  * [Manage Seciton Box - Settings](add-ins/filter+-section-box/manage-seciton-box-settings.md)
...
* [Grid to Crop](add-ins/grid-to-crop.md)
* [IDs](add-ins/ids.md)
...
* [24-09-23 : BIMIL 1.0.7.0](release-notes/24-09-23-bimil-1.0.7.0.md)
