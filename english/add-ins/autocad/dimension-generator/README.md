---
description: Automatically place centerline and polyline dimensions in one click.
---
...
* **Two ways to pick targets:** _Select Objects_ to dimension only the objects you pick, or _Select by Layer_ to dimension every line and polyline on a chosen layer.
