...
Open **Table Paste** from the BIMIL ribbon (or run `BP_TBP` / `TBP`) after copying a table. The window shows what was found in the clipboard, the estimated drawing size, and the placement settings that will be used for the AutoCAD table.
