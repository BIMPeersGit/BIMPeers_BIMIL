...
Preprocess SketchUp Scenes for AI and export them to ArchiFilm Studio Web **with one click**.\
Automatically captures camera angle, perspective, and model geometry, enabling seamless transfer into the AI rendering workflow without any manual export steps.
...
Preprocess Revit Views for AI and export them to ArchiFilm Studio Web **with one click**.\
Sends Active View with camera settings, crop region, and perspective intact for instant AI-based architectural visualization.
