...
1. **Set it up** — open **Settings**, choose how the label should look, and click **Apply**. See [Settings](settings.md) for each option.
...
* Settings are kept for the AutoCAD session. If you have not applied any yet, the command runs with the default settings.
