...
* ![](../../.gitbook/assets/Icon_12_Type.png) Type: Shared values across elements of the same type.
...
* <img src="../../.gitbook/assets/ScheduleParam_12_Light (1).png" alt="" data-size="line"> <mark style="background-color:yellow;">Schedule-Only</mark> _<mark style="background-color:yellow;">(v1.0.1.0+):</mark>_ <mark style="background-color:yellow;">Parameters that are exclusive to the Schedule tab.</mark>
...
#### <mark style="background-color:yellow;">※ Export Options (Schedule Only)</mark> _<mark style="background-color:yellow;">(v1.0.1.0+)</mark>_
...
<figure><img src="../../.gitbook/assets/Edit.gif" alt="" width="563"><figcaption></figcaption></figure>
