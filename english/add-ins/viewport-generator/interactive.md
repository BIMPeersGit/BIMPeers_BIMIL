...
2. **Set the output** — **Viewport Scale**, **Source Layout**, and **Sheet Prefix / Start** (see the [overview](README.md) for these shared settings). The frame size comes from the source layout's viewport.
